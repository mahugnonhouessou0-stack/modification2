...
const S00_Events = [
  {
    text: "Durant cette notion, tu seras avec une camarade.",
    x: 0.5,
    y: 0.15,
    sz: 0.035,
    color: CW,
  ...
  {
    text: "Tu comprends plus vite qu'elle alors tu es appelé à répondre à ses questions de compréhension.",
    x: 0.5,
    y: 0.25,
    sz: 0.035,
    color: CW,
  ...
  {
    text: "Sa compréhension définit ta réussite ! ",
    x: 0.5,
    y: 0.35,
    sz: 0.035,
    color: CW,
...
const S1_Events = [
  {
    text: "Notion : Les diviseurs d’un nombre",
    y: 0.1,
    sz: 0.06,
    bold: true,
    color: CY,
  ...
  {
    text: "Imagine que vous êtes 12 dans ta classe , le professeur te demande alors de vous diviser en groupes de 3.",
    y: 0.25,
    sz: 0.035,
    color: CW,
  },
  {
    text: "Combien de groupes de 3 pourra-t-on former ?",
    y: 0.3,
    sz: 0.035,
    color: CW,
  },
  ...
  {
    text: "En résumé : dans 12 on peut trouver 6 fois le nombre 2, 4 fois le nombre 3 etc...",
    y: 0.75,
    sz: 0.035,
    color: CB,
  },
  {
    text: "On peut écrire : 12/2 = 6 ; 12/3 = 4 ; 12/4 = 3 ; 12/6 = 2 ; 12/12 = 1.",
    y: 0.82,
    sz: 0.035,
    color: CW,
  },
  {
    text: "Les diviseurs de 12 sont : 1, 2, 3, 4, 6, 12.",
    y: 0.9,
    sz: 0.04,
    color: CG,
    bold: true,
...
const S2_Events = [
  ...
  {
    text: "Preno nons les nombres suivants : 1, 2,",
    y: 0.25,
    sz: 0.035,
    color: CW,
  },
  {
    text: "Mais regarde le nombre 5 par exemple.",
    y: 0.3,
    sz: 0.035,
    color: CW,
  },
  ...
  { type: "clear", target: "traits_groupes" },
  {
    text: "Un nombre qui n'a que deux diviseurs (1 et lui-même) est un NOMBRE PREMIER.",
    y: 0.8,
    sz: 0.04,
    color: CG,
    bold: true,
  ...
  {
    text: "9 n'est pas premier car il est divisible par 1, 3 et 9.",
    y: 0.9,
    sz: 0.035,
    color: CB,
  },
...
const S3_Events = [
  {
    text: "Notion : Décomposition en facteurs premiers",
    y: 0.1,
    sz: 0.06,
    bold: true,
    color: CY,
  ...
  {
    text: "Tout nombre peut s'écrire comme un produit de nombres premiers.",
    y: 0.25,
    sz: 0.035,
    color: CW,
  },
...
const S4_Events = [
  {
    text: "Notion : Angles au centre d'un cercle",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  {
    type: "text",
    text: "Quel est le centre de ce cercle ?",
    x: 0.15,
    y: 0.25,
    sz: 0.035,
    start: 120,
  ...
  {
    type: "text",
    text: "Le centre de ce cercle est : O",
    x: 0.05,
    y: 0.82,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Quel est le sommet de cet angle ?",
    x: 0.63,
    y: 0.25,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Le sommet de cet angle est : C",
    x: 0.6,
    y: 0.65,
    sz: 0.035,
    color: CW,
...

  {
    ...
    options: [
      ...
      {
        text: "C'est devenu le point O qui est le centre du cercle",
        isCorrect: true,
      },
  ...
  {
    type: "text",
    text: "Autrement dit, il est devenu un angle au centre d'un cercle. On le note désormais : AÔB",
    x: 0.1,
    y: 0.8,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Un angle est dit angle au centre d'un cercle lorsque son sommet est le centre du cercle.",
    x: 0.21,
    y: 0.85,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Un arc est une portion d'un cercle.",
    x: 0.63,
    y: 0.25,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "L'arc A͡B est donc la portion du cercle qui couvre l'angle AÔB.",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "On dit que l'arc A͡B intercepte l'angle AÔB.",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Quel est l'arc qui intercepte l'angle CÔB ?",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Nous avons deux types d'arc :",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Les petits arcs et les grands arcs.",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Les arcs A͡B et B͡C sont des petits arcs.",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "L'arc A͡B intercepte l'angle AÔB: ",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "L'arc ~AB intercepte l'angle ~AOB: ",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Le fait que plus l’angle au centre est grand, plus l’arc correspondant est long, ",
    x: 0.05,
    y: 0.75,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "veut dire que la longueur d’un arc de cercle est proportionnelle à la mesure de l’angle au centre qui l’intercepte. ",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Autrement dit, si on double l’angle, on double aussi la longueur de l’arc.",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: CW,
  ...
  { type: "SEP" },
  { type: "cercle", x: 0.17, y: 0.5, r: 0.25, color: CB, duration: 300 },
  ...
  { type: "cercle", x: 0.72, y: 0.5, r: 0.25, color: CB, duration: 300 },
  // Premier angle : de 0° à 60°
  {
    type: "arc_angle_growth",
    x: 0.72,
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Oui, c'est pour dire que lorsque mes(AÔB)=mes(CÔD) alors L(A͡B)=L(C͡D)",
        isCorrect: true,
      },
      { text: "Non", isCorrect: false },
    ],
  ...
  {
    type: "text",
    text: "Dans un cercle, si deux angles au centre ont la même mesure, ",
    x: 0.05,
    y: 0.3,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "alors ils interceptent deux arcs de même longueur.",
    x: 0.05,
    y: 0.35,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Dans un cercle si deux arcs ont la même longueur  ",
    x: 0.05,
    y: 0.4,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "alors ils interceptent deux angles au centre de même mesure.",
    x: 0.05,
    y: 0.45,
    sz: 0.035,
    color: "#ffffff",
...
const S5_Events = [
  {
    text: "Notion : La corde d'un cercle",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  { type: "cercle", x: 0.65, y: 0.52, r: 0.2, color: CB, duration: 300 },
  ...
  {
    type: "text",
    text: "Combien de segment peut-on construire ",
    x: 0.52,
    y: 0.8,
    sz: 0.038,
    color: CW,
  ...
  {
    type: "text",
    text: "avec ces 3 points qui sont sur le cercle?",
    x: 0.52,
    y: 0.85,
    sz: 0.038,
    color: CW,
  ...
  {
    type: "text",
    text: "Il y a 3 segments si on ne compte pas le diametre du cercle.",
    x: 0.15,
    y: 0.5,
    sz: 0.038,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Ce type de segment qui relie deux points sur un cercle, on les appelle : ",
    x: 0.05,
    y: 0.55,
    sz: 0.038,
    color: CW,
  ...
  {
    type: "text",
    text: "Le diametre est la plus grande corde d'un cercle ",
    x: 0.05,
    y: 0.55,
    sz: 0.038,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "Quelles sont les cordes de ce cercle ?",
    x: 0.05,
    y: 0.2,
    sz: 0.038,
    color: CW,
  ...
  // Cercle à gauche
  { type: "cercle", x: 0.25, y: 0.52, r: 0.2, color: CB, duration: 300 },
  ...
  {
    type: "text",
    text: "On remarque que chacune des cordes sont ",
    x: 0.45,
    y: 0.3,
    sz: 0.038,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "1. On dit plutôt qu'une corde sous-tend un arc",
    x: 0.45,
    y: 0.4,
    sz: 0.038,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "Ex : La corde [EF] sous-tend l'arc E͡F .",
    x: 0.45,
    y: 0.45,
    sz: 0.038,
    color: CW,
  ...
  {
    type: "text",
    text: "Ou encore, l'arc E͡F est sous-tendu par la corde [EF] ",
    x: 0.45,
    y: 0.5,
    sz: 0.038,
    color: CW,
  ...
  {
    type: "text",
    text: "1. Dans un cercle, si deux arcs ont la même longueur,",
    x: 0.45,
    y: 0.3,
    sz: 0.038,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "alors les deux cordes qui les sous-tendent ont la même longueur.",
    x: 0.45,
    y: 0.35,
    sz: 0.038,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "2. Dans un cercle, si deux cordes ont la même longueur,",
    x: 0.45,
    y: 0.4,
    sz: 0.038,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "alors les deux arcs qu’elles sous-tendent ont la même longueur.",
    x: 0.45,
    y: 0.45,
    sz: 0.038,
    color: "#ffffff",
...
const S6_Events = [
  {
    text: "Notion : Distance d'un point à une droite",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  { type: "text", text: "(D)", x: 0.57, y: 0.7, sz: 0.04, color: "#8dd0f0" },
  ...
  {
    type: "text",
    text: "Il y a 5 chemins pour aller de A à la droite (D). Lequel est le plus court ?",
    x: 0.05,
    y: 0.2,
    sz: 0.04,
    color: CW,
  ...
  {
    type: "text",
    text: "Si on prend une règle pour mésurer, on voit que c'est : [AH].",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Quand on demande de calculer la distance d'un point à une droite,",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "c'est la distance la plus courte qui est la bonne réponse.",
    x: 0.05,
    y: 0.9,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "c'est la distance dont le support est perpendiculaire à cette droite.",
    x: 0.05,
    y: 0.9,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "On note :  d(H,(D))= AH et on lit : la distance de A par rapport à (D) est AH ",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "Si d désigne la distance d’un point A à une droite (D), alors pour tout point M de (D) on a :  d = AM ou d < AM. ",
    x: 0.05,
    y: 0.9,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: " Si le point A appartient à (D), alors sa distance à la droite (D) est égale à zéro. ",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#f5e441",
...
const S7_Events = [
  {
    text: "Notion : Distance entre deux droites parallèles",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  {
    type: "text",
    text: "Quelle est la distance qui sépare (D1) de (D2) ?",
    x: 0.05,
    y: 0.85,
    sz: 0.04,
    color: CW,
  ...
  {
    type: "text",
    text: "(D1) et (D2) sont deux droites parallèles. Une perpendiculaire en un point A à (D1) coupe (D2) en un point H.",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#f5e441",
  ...
  {
    type: "text",
    text: "On appelle distance des droites parallèles (D1) et (D2) la distance AH. ",
    x: 0.05,
    y: 0.9,
    sz: 0.035,
    color: "#f5e441",
...
const S8_Events = [
  {
    text: "Notion : Points équidistants de deux droites parallèles",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  {
    type: "text",
    text: "Traçons deux droites parallèles (D1) et (D2).",
    id: "ligne_speciale",
    x: 0.05,
    y: 0.2,
    sz: 0.04,
  ...
  {
    type: "text",
    text: "Traçons à présent une droite perpendiculaire à ces deux droites.",
    id: "ligne_speciale",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  {
    type: "text",
    text: "Cette droite coupe (D1) en A et (D2) en B.",
    id: "ligne_speciale",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  {
    type: "text",
    text: "Voici (L) l'axe médian de (D1) et (D2), C'est la médiatrice du segment [AB]:",
    id: "ligne_speciale",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  { type: "text", text: "(L)", x: 0.67, y: 0.5, sz: 0.04, color: "#f5e441" },
  ...
  {
    type: "text",
    text: "Donc AM=MB. Autrement dit, M est équidistant de (D1) et (D2)",
    tag: "groupe_a_effacer",
    x: 0.05,
    y: 0.75,
    sz: 0.035,
  ...
  {
    type: "text",
    text: "Donc JC=CK. Autrement dit, C est équidistant de (D1) et (D2)",
    tag: "groupe_a_effacer",
    x: 0.05,
    y: 0.75,
    sz: 0.035,
  ...
  {
    type: "text",
    text: "Donc SF=FL. Autrement dit, F est équidistant de (D1) et (D2)",
    tag: "groupe_a_effacer",
    x: 0.05,
    y: 0.75,
    sz: 0.035,
  ...
  {
    type: "text",
    text: "Si un point appartient à l'axe médian de deux droites parallèles alors il est équidistant de ces deux droites.",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Si un point est équidistant de deux droites parallèles alors il appartient à l'axe médian de ces deux droites.  ",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#ffffff",
...
const S9_Events = [
  {
    text: "Notion : Points équidistants de deux droites sécantes",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.05,
  ...
  {
    type: "text",
    text: "Traçons un angle de sommet O.",
    x: 0.05,
    y: 0.2,
    sz: 0.04,
    color: CW,
  ...
  {
    type: "text",
    text: "Traçons la bissectrice de cet angle.",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Plaçons un point M sur la bissectrice.",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Mesurons la distance de M à chaque côté de l'angle.",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "En mesurant, on observe que MH = MK.",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "On peut refaire le même constat avec n'importe quel autre point de (B).",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
    color: CW,
  ...
  {
    type: "text",
    text: "Si un point appartient à la bissectrice d'un angle, alors il est équidistant des deux côtés de cet angle.",
    x: 0.05,
    y: 0.8,
    sz: 0.035,
    color: "#ffffff",
  ...
  {
    type: "text",
    text: "Si un point est équidistant des deux côtés d'un angle, alors il appartient à la bissectrice de cet angle.",
    x: 0.05,
    y: 0.85,
    sz: 0.035,
    color: "#ffffff",
...
const S10_Events = [
  {
    text: "Notion S10 : Axe de symétrie de deux droites sécantes",
    isTitle: true,
    x: 0.05,
    y: 0.08,
    sz: 0.045,
  ...
  {
    text: "(OA) et (OB) sont deux droites sécantes en O.",
    id: "txt",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  { type: "clear", id: "txt" },
  {
    text: "(OE) est la demi-droite opposée à (OB).",
    id: "txt",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  { type: "clear", id: "txt" },
  {
    text: "(D) est la bissectrice de l'angle AÔB (60° ÷ 2 = 30°).",
    id: "txt",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  { type: "clear", id: "txt" },
  {
    text: "(D') est la bissectrice de l'angle AÔE (130° ÷ 2 = 65°).",
    id: "txt",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  {
    text: "Les deux bissectrices sont perpendiculaires !",
    x: 0.05,
    y: 0.85,
    sz: 0.04,
    bold: true,
  ...
  { type: "clear", id: "txt" },
  {
    text: "Symétries par rapport à (D') :",
    id: "txt",
    x: 0.05,
    y: 0.2,
    sz: 0.035,
  ...
  {
    text: "Reflétons (OA) par rapport à (D')...",
    x: 0.05,
    y: 0.25,
    sz: 0.03,
    color: CW,
  ...
  { text: "Reflétons (OB)...", x: 0.05, y: 0.3, sz: 0.03, color: CW },
  {
    type: "reflet",
    ox: 0.5,
    oy: 0.55,
  ...
  {
    type: "text",
    text: "1. Les deux bissectrices sont perpendiculaires.",
    x: 0.05,
    y: 0.28,
    sz: 0.033,
    color: CW,
  ...
  {
    type: "text",
    text: "2. Chaque bissectrice est un axe de symétrie.",
    x: 0.05,
    y: 0.33,
    sz: 0.033,
    color: CW,
  ...
  {
    type: "text",
    text: "3. Tout point sur une bissectrice est équidistant des deux droites.",
    x: 0.05,
    y: 0.38,
    sz: 0.033,
    color: CG,
...
const S12_Events = [
  {
    text: "Notion : La médiane d'un triangle",
    y: 0.08,
    sz: 0.055,
    bold: true,
    color: CY,
  ...
  {
    text: "Reprenons notre triangle ABC.",
    x: 0.05,
    y: 0.16,
    sz: 0.032,
    color: CW,
  ...
  {
    type: "question",
    text: "Sais-tu ce qu'est la médiane d'un triangle ?",
    options: [
      { text: "Oui, je crois", isCorrect: true },
      { text: "Non, aucune idée", isCorrect: false },
    ],
  ...
  { text: "Définition :", x: 0.05, y: 0.7, sz: 0.032, bold: true, color: CY },
  {
    text: "La médiane issue d'un sommet passe",
    x: 0.05,
    y: 0.75,
    sz: 0.028,
    color: CW,
  ...
  {
    text: "par le milieu du côté opposé.",
    x: 0.05,
    y: 0.79,
    sz: 0.028,
    color: CW,
  ...
  // --- Médiane issue de A, vers le milieu de (BC) ---
  {
    type: "question",
    text: "La médiane issue de A doit rejoindre le milieu de quel côté ?",
    options: [
      { text: "Le milieu de (BC)", isCorrect: true },
      { text: "Le milieu de (AB)", isCorrect: false },
      { text: "Le milieu de (AC)", isCorrect: false },
    ],
  },
  {
    type: "line",
  ...
  // --- Médiane issue de B, vers le milieu de (AC) ---
  {
    type: "question",
    text: "Et la médiane issue de B, vers le milieu de quel côté ?",
    options: [
      { text: "Le milieu de (AC)", isCorrect: true },
      { text: "Le milieu de (BC)", isCorrect: false },
      { text: "Le milieu de (AB)", isCorrect: false },
    ],
  },
  {
  ...
  // --- Médiane issue de C, vers le milieu de (AB) ---
  {
    type: "question",
    text: "Enfin, la médiane issue de C, vers le milieu de quel côté ?",
    options: [
      { text: "Le milieu de (AB)", isCorrect: true },
      { text: "Le milieu de (BC)", isCorrect: false },
      { text: "Le milieu de (AC)", isCorrect: false },
    ],
  },
  ...
  // --- Point de concours ---
  {
    type: "question",
    isVerification: true,
    text: "Regarde bien les 3 médianes : que remarques-tu ?",
    options: [
      { text: "Elles sont parallèles", isCorrect: false },
      { text: "Elles se croisent toutes au même point", isCorrect: true },
      { text: "Elles ne se touchent jamais", isCorrect: false },
  ...
  { text: "G", x: 0.245, y: 0.445, sz: 0.032, color: "#ffffff" },

  {
    text: "Remarque : les trois médianes se coupent en un même point.",
    x: 0.05,
    y: 0.86,
    sz: 0.03,
    color: CB,
  ...
  {
    text: "Ce point s'appelle le CENTRE DE GRAVITÉ du triangle.",
    x: 0.05,
    y: 0.91,
    sz: 0.032,
    color: CG,
...
export const notions = {
  ...
  S11: {
    id: "S11",
    title: "La hauteur d'un triangle",
    events: S11_Events,
    nextNotionId: "S12",
  },
  S12: {
    id: "S12",
    title: "La médiane d'un triangle",
    events: S12_Events,
    nextNotionId: "S1",
  },
};
